...
<div class="contact_page_section pt-5 pb-5">
	<div class="container-xl">
		<div class="row">
			<div class="col-xl-7 col-lg-7 col-md-7 col-sm-12 col-12">
				<div class="contact_info_section">
					<div class="row">
						<div class="col-xl-6 col-md-6 col-md-6 col-sm-6 col-12">
				...
				<img src="images/contact.png" alt="..." class="img-fluid d-block mx-auto">
			</div>
